...
def net_construct(structure='vgg16',dropout=0.5, hidden_layer1 = 4096,lr = 0.001,device='gpu'):
...
def deep_learning(model, criterion, optimizer, epochs = 3, print_every=40, loader=0, device='gpu'):
    steps = 0
...
def load_checkpoint(path='checkpoint.pth'):
    ...
    model,_,_ = net_construct(structure , dropout,hidden_layer1,lr)
